        ...
        <div class="stats-grid">
            ...
            <div class="stats-card">
                ...
                foreach ($districts as $district) {
                    ...
                    echo "<span class='stat-label'>" . htmlspecialchars($district['district']) . "</span>";
                    echo "<span class='stat-value'>" . htmlspecialchars($district['count']) . "</span>";
                    echo "</div>";
                    ...
                    foreach ($divisions as $division) {
                        if ($division['district'] === $district['district']) {
                            ...
                            echo "<span class='stat-value'>" . htmlspecialchars($division['count']) . "</span>";
                            echo "</div>";
                        }
                    }
                }
